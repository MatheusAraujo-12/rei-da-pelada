...
const CreatePlayerProfile = ({ onSave, user }) => {
    ...
    const [age, setAge] = useState('');
    const [position, setPosition] = useState('Linha');
    const initialLineSkills = { finalizacao: 50, drible: 50, velocidade: 50, folego: 50, passe: 50, desarme: 50 };
    const initialGkSkills = { reflexo: 50, posicionamento: 50, lancamento: 50 };
    const [skills, setSkills] = useState(initialLineSkills);
