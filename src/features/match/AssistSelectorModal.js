...
const AssistSelectorModal = ({ isOpen, onClose, teammates, onSelectAssister }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50 p-4">
            <div className="bg-gray-900 rounded-2xl shadow-2xl p-6 w-full max-w-sm text-white border border-cyan-400/30">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-cyan-400">Quem deu a assistência?</h2>
                ...
                <div className="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    >
                        ...
                        <span className="font-semibold">Sem Assistência / Golo Individual</span>
                    </button>
                </div>
            </div>
        </div>
